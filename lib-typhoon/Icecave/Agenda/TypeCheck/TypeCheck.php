...
abstract class TypeCheck
{
    ...
    {
        $validatorClassName = '\\Icecave\\Agenda\\TypeCheck\\Validator\\' . $className . 'TypeCheck';
    ...
    {
        return new \Eloquent\Typhoon\Configuration\RuntimeConfiguration(\Eloquent\Cosmos\ClassName::fromString('\\Icecave\\Agenda\\TypeCheck'), false);
    }
